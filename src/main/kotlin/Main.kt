 ...
 * squareFootage: Square Footage of the area that needs mowing
 */
...
/**
 * Child class Commercial (Parent class Customer)
 *
 * @param
 * multiProperty: Boolean for if the customer is eligible for the multi-property discount
 * rate: rate at which the customer is charged
 * (inherited) customerName: Name of the customer
 * (inherited) customerPhone: Phone number of the customer
 * (inherited) customerAddress: Address of the customer
 * (inherited) squareFootage: Square Footage of the area that needs mowing
 */
...
/**
 * Child class Residential (Parent class Customer)
 *
 * @param
 * senior: Boolean for if the customer is eligible for the multi-property discount
 * rate: rate at which the customer is charged
 * (inherited) customerName: Name of the customer
 * (inherited) customerPhone: Phone number of the customer
 * (inherited) customerAddress: Address of the customer
